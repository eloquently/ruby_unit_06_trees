...
# given arrays of the elements in a tree generated by a in-order traversal and the post-order traversal
# of a tree, construct the tree and return the root
def build_tree(in_order_elements, post_order_elements)
end